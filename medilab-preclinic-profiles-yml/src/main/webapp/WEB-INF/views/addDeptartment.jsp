    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form:form action="./saveDept" modelAttribute="dept">
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									...
									<form:radiobutton path="status" class="form-check-input" id="product_active" value="active" checked="true"/>
								...
								<div class="form-check form-check-inline">
									...
									<form:radiobutton path="status" class="form-check-input" id="product_active" value="inactive" />
