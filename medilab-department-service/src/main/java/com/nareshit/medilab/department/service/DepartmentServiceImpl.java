...
import com.nareshit.medilab.exception.ExceptionConstants;
...
public class DepartmentServiceImpl implements DepartmentService {
	...
	/*@Transactional(isolation=Isolation.READ_COMMITTED,
			...
			//rollbackFor=DuplicateDepartmentException.class,
			readOnly=false)*/
	@Override
	public DepartmentBean save(DepartmentBean deptBean) throws DuplicateDepartmentException {
		...
		try {
			...
			throw new DuplicateDepartmentException(env.getProperty(ExceptionConstants.DUPLICATE_DEPT_MESSAGE));
		}
